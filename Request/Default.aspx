    ...
    <table>
        <tr>
            <td style="vertical-align:top">
                ...
                <asp:UpdatePanel ID="RequestDetails" runat="server" ChildrenAsTriggers="true" EnableViewState="false">
                    <ContentTemplate>
            ...
            <td style="vertical-align:top">
                ...
                <div class="form-group">
                    ...
                    <asp:UpdatePanel ID="UploadedFilesPanel" runat="server" UpdateMode="Conditional" >
                        <ContentTemplate>
                            <asp:GridView ID="UploadedFiles" runat="server" AutoGenerateColumns="false" EmptyDataText="There are no uploaded files." >
                                <Columns>
